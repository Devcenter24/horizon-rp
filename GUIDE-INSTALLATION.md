...
à la racine du site. Il fait deux choses :
- sert `/dashboard`, `/recrutement` et `/mentions-legales` **sans slash
  final** comme URL canonique (au lieu de `/dashboard/`)
- redirige proprement vers `/404.html` toute URL inconnue
