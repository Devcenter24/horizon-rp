...
create table if not exists settings (
  ...
  preview_items jsonb not null default '[
    {"icon": "game", "label": "Jeu support", "value": "Emergency Hamburg"},
    {"icon": "roles", "label": "Métiers jouables", "value": "8 rôles"},
    {"icon": "language", "label": "Langue", "value": "Francophone"},
...
-- Si la table existait déjà avant cette mise à jour (sans preview_items),
-- cette commande l'ajoute sans rien casser :
alter table settings add column if not exists preview_items jsonb not null default '[
  {"icon": "game", "label": "Jeu support", "value": "Emergency Hamburg"},
  {"icon": "roles", "label": "Métiers jouables", "value": "8 rôles"},
  {"icon": "language", "label": "Langue", "value": "Francophone"},
  {"icon": "clock", "label": "Disponibilité", "value": "24/7"}
